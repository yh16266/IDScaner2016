...
public class PrintUtils {
	...
	public static void printImage(Resources resources, PrinterInstance mPrinter, boolean isStylus) {
		mPrinter.init();
		Bitmap bitmap = BitmapFactory.decodeResource(resources,R.drawable.indicator_arrow);
	...
	public static void printCustomImage(Resources resources,
		...
		cp.drawImage(BitmapFactory.decodeResource(resources,R.mipmap.my_picture));
