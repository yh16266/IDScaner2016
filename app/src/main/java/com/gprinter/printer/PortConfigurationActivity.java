...
public class PortConfigurationActivity extends Activity{
    ...
    private EditText etIpAddr,etPortNum;
	// Return Intent extra
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.gprinter_dialog_port_configuration);
		initView();
		mPortParam = new PortParameters();
	}
	private void initView(){
		etIpAddr =(EditText)findViewById(R.id.etIpAddress);
	...
	public void okButtonClicked(View view){
		...
		{
				mPortParam.setIpAddr(etIpAddr.getText().toString());
				mPortParam.setPortNumber(Integer.parseInt(etPortNum.getText().toString()));
		}
